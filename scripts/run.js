...
const main = async () => {
    const memoryContractFactory = await hre.ethers.getContractFactory("Scrapbook");
    ...
    let txn = await memoryContract.createNewMemory(memCID, eventTimeStamp, memoryId, visible);
